  ...
  return (
    ...
    >
      <Col xs={22} sm={18} md={14} lg={10}>
        ...
        <Space size="large" wrap style={{ display: 'flex', justifyContent: 'center', marginBottom: '24px' }}>
          {/* Geri Dönüşüm Malzemesi Ekle */}
          <Card style={{ width: '300px', minHeight: '180px', textAlign: 'center', padding: '16px' }}>
            <Text strong>
...
>
  Malzeme Geçmişi
        ...
        <Card style={{ textAlign: 'center' }}>
          ...
          <Title level={3} style={{ marginTop: '10px', color: '#2e7d32' }}>0 Çip</Title>
        </Card>
      </Col>
    </Row>
  );
